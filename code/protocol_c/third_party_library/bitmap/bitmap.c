...
static uint32_t bitmap_web_destroy(bitmap_t* bitmap) {
...
uint32_t bitmap_init_rgba8888(bitmap_t* b, uint32_t w, uint32_t h, const uint8_t* data,
                           uint32_t comp) {
  uint32_t i = 0;
...
uint32_t bitmap_init_bgra8888(bitmap_t* b, uint32_t w, uint32_t h, const uint8_t* data,
                           uint32_t comp) {
  uint32_t i = 0;
  uint32_t n = w * h;
  const uint8_t* s = data;
...
uint32_t bitmap_init_bgr565(bitmap_t* b, uint32_t w, uint32_t h, const uint8_t* data, uint32_t comp) {
  uint32_t i = 0;
  uint32_t n = w * h;
  const uint8_t* s = data;
...
uint32_t rgba_data_premulti_alpha(const uint8_t* data, uint8_t a_index, uint32_t w, uint32_t h) {
  uint32_t i = 0;
  uint32_t k = 0;
  uint32_t n = w * h;
